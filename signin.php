      ...
      <div class="col-lg-5 col-xl-6 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          <div class="card-body p-4 p-sm-5">
            ...
            <h5 class="card-title text-center mb-5 fw-light fs-5">Sign In here</h5>
            ...
            ?>
            <form action="controller/signin_con.php" method="post">          

              <div class="form-floating mb-3">
                <input type="text" class="form-control" name="username" id="floatinguname" placeholder="Userame" required autofocus>
              </div>
              ...
              <div class="d-grid mb-2">
                <button class="btn btn-primary btn-login fw-bold text-uppercase" name="signin" type="submit">Sign In</button>
              </div>

              <a class="d-block text-center mt-2 medium" href="signup.php">Not have an account? Sign Up</a>
              <hr class="my-4">
